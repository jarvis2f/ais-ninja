import {addAdminPayment, delAdminPayment, getAdminPayment, putAdminPayment} from '@/request/adminApi'
import {AlipayInfo, PaymentInfo, StripeInfo, YipayInfo} from '@/types/admin'
import {
	ActionType,
	BetaSchemaForm,
	ModalForm,
...
type MIXInfo = PaymentInfo & AlipayInfo & YipayInfo & StripeInfo
		...
		stripe: [
			{
				...
				columns: [
					...
					{
						title: '支付成功success_url',
						dataIndex: 'success_url',
						width: 'sm'
					},
					{
						title: '取消支付cancel_url',
